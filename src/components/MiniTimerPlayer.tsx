    ...
    <div className="bg-indigo-950/90 border-t border-indigo-800/80 backdrop-blur-md px-4 py-2.5 text-slate-100 shadow-lg">
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-3">
        <div
          ...
          className="flex items-center gap-3 cursor-pointer flex-1 min-w-0 hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded-lg p-1 transition-all"
        >
        ...
        <div className="flex items-center gap-2">
          {activity.isPaused ? (
            <button
              ...
              className="p-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
            ...
            <button
              ...
              className="p-1.5 rounded-lg bg-amber-600 hover:bg-amber-500 text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400"
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-rose-600 hover:bg-rose-500 text-white transition-colors flex items-center gap-1 text-xs font-medium px-2.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-400"
